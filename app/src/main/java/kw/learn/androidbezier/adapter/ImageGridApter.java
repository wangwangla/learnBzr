...
public class ImageGridApter extends BaseRecyclerAdapter<ImageFolderBean, RecyclerView.ViewHolder> {
    ...
    private void notifyImageChanged (ImageView imageView, ImageFolderBean imageBean) {
        ...
        ImageLoader.getInstance().displayImage(ImageDownloader.Scheme.FILE.wrap(imageBean.path),
                imageView, ImageLoaderHelper.buildDisplayImageOptionsDefault(R.drawable.defaultpic), displayListener);
    }
